perm filename FX2.MAC[F40,SYS]2 blob sn#223167 filedate 1976-07-05 generic text, type C, neo UTF8
COMMENT!C"≈!c   VALID 00164 PAGES
C REC  PAGE   DESCRIPTION
C00001 00001
C00012 00002		SUBTTL	FX2 V.25	20-JAN-72
C00013 00003	LAPSAV:					LOOK AHEAD POSITION SAVE
C00015 00004	BSSLIN:					BUILD SYS SR LINK
C00017 00005	BUIINS:					BUILD INSTRUCTION
C00020 00006	BARREF:					BUILD ARRAY REF
C00022 00007	SCRGEN:					SCRIPT GEN
C00024 00008	BCOREF:					BUILD CONST REF
C00027 00009	DCOREG:					DOUBLE CONST REG
C00029 00010	PRORUN:					PROGRAM RUN
C00031 00011	SCACLO:					SCAN CLOSE
C00035 00012	BENHEA:					BIN ENTRY HEADER
C00037 00013	BSAAIA:					BIN SAVE ACS AND INIT ARGS
C00038 00014	INIARG:					INIT ARGS
C00041 00015	BREARG:					BIN RESTORE ARGS
C00044 00016					22 LINES DELETED	"23C"
C00046 00017
C00048 00018	STASCA:					STA SCAN
C00050 00019	LFIXLA:					LBL FIELD XLATE
C00051 00020	STAXLA:					STA XLATE
C00052 00021	SSTXLA:					SUBROUTINE STA XLATE
C00056 00022	FSTXLA:					FUNCTION STA XLATE
C00059 00023	MPRXLA:					MAIN PROGRAM XLATE
C00062 00024	LISXL3:
C00064 00025	DODODI:					DO OR DATA OR DIMENSION
C00069 00026	DORDIM:					DATA OR DIMENSION
C00070 00027	DSEXLA:					DIMENSION SEQ XLATE
C00072 00028	DSEXL6:
C00074 00029	FNDXLA:					FINISH NON-DMY DIMENS XLATE
C00076 00030	LPASCA:					LIMIT PAIR SCAN
C00078 00031	IFNDEF	$DATA,
C00081 00032	IFNDEF	$DATA,
C00084 00033	IFNDEF	$DATA,
C00086 00034	IFNDEF	$DATA,
C00088 00035	IFNDEF	$DATA,
C00090 00036	IFNDEF	$DATA,
C00092 00037	IFNDEF	$DATA,
C00094 00038	IFNDEF	$DATA,
C00095 00039	IFNDEF	$DATA,
C00097 00040	GTOGRO:					GO TO GROUP
C00099 00041	AGTSXL:					ASSIGN GO TO STA XLATE
C00101 00042	AOAXLA:					ASSIGNMENT OR AFDS XLATE
C00103 00043	AOAXL1:
C00106 00044	DPCHEC:					DP CHECK
C00107 00045	ASTXLA:					ASSIGNMENT STA XLATE
C00111 00046	SACAGE:					SPECIAL ASSIGNMENT CHECK AND GEN
C00113 00047	SPACHE:					SUBEXP PARTS CHECK
C00115 00048	SPACH1:
C00117 00049	OASCHE:					ORDER AND SIGN CHECK
C00119 00050	FOSTXL:					FORMAT STA XLATE
C00121 00051	FLISCA:					FORMAT LIST SCAN
C00122 00052	FBASCA:					FORMAT BASIC SCAN
C00124 00053		CSA	(O)		O
C00127 00054	RFOSPR:					REGISTER FORMAT SPROGS
C00128 00055	CSTXLA:					CALL STA XLATE
C00132 00056	WSTXLA:					WRITE STA XLATE
C00136 00057	FRESCA:					FORMAT REFERENCE SCAN
C00141 00058
C00142 00059	IARSIZ:					INSERT ARRAY SIZES
C00146 00060
C00148 00061
C00150 00062	IVAXLA:					IO VAR XLATE
C00153 00063	INSTXL:					INTEGER STA XLATE
C00156 00064		FET	(ZERO)	ZERO
C00157 00065	CXSTXL:					COMPLEX STA XLATE
C00160 00066	SISXLA:					SUBSCRIPT INTEGER STA XLATE
C00161 00067	IFNDEF	$NAME,
C00163 00068	IFNDEF	$IMPL,
C00167 00069	IFNDEF	$IMPL,
C00169 00070	CMSTXL:					COMMON STA XLATE
C00171 00071	ESEXLA:					EQUIV SEG XLATE
C00173 00072	EXSTXL:					EXTERNAL STA XLATE
C00176 00073	ASSTXL:					ASSIGN STA XLATE
C00179 00074	RWSTXL:					REWIND STA XLATE
C00181 00075	ENDXLA:					END XLATE
C00183 00076
C00186 00077	AEXSCA:					ARG EXP SCAN
C00188 00078	COLSUB:					COLLAPSE SUBORDS
C00190 00079	IFNDEF	$CCONS,
C00192 00080	IFNDEF	$CCONS,
C00193 00081	ATNAMO:					ADD TO NEST AND MOVE
C00196 00082	SUBREG:					SUBEXP REGISTER
C00198 00083	ELESCA:					ELEMENT SCAN
C00201 00084	AELSCA:					APPENDED ELEM SCAN
C00205 00085	AREXLA:					ARRAY REF XLATE
C00208 00086	AREXL7:
C00210 00087	AREXL4:
C00212 00088
C00214 00089	ACCAGE:					ASSIGNMENT CONV CHECK AND GEN
C00218 00090	EIRGAS:					EXP IN REG GEN AND SAVE
C00220 00091	SUBGEN:					SUBEXP GEN
C00222 00092	EQVGEN:					EQV GEN
C00224 00093	GTLTGE:					GT LT GEN
C00227 00094	RELGE8:
C00230 00095	ICLGEN:					IF CLOSE GEN
C00232 00096	GLECHE:					GE LE CHECK
C00233 00097	CSIGEN:					CHANGE SIGN GEN
C00235 00098	DCLGEN:					DO CLOSE GEN
C00238 00099	CILCGE:					CONST INCR LOOP CLOSE GEN
C00240 00100	LSHGEN:					LOCAL SPROG HEAD GEN
C00241 00101					23 LINES DELETED	"23C"
C00245 00102	ASUGEN:				ADD SUB GEN
C00247 00103	DIVGEN:					DIV GEN
C00249 00104	RFBGEN:					READY FOR BINARY GEN
C00256 00105	EXPGEN:					EXPON GEN
C00257 00106	EBMGEN:					EXPON BY MPY GEN
C00260 00107	EBSGEN:					EXPON BY SR GEN
C00262 00108	CTFLGE:					CONV TO FL GEN
C00265 00109	ESIGEN:					EXPON SINGLE GEN
C00268 00110	FRPGEN:					FUNC REF PNTR GEN
C00270 00111	ARPGEN:					ARRAY REF PNTR GEN
C00272 00112	DTYCHE:					DP TYPE CHECK
C00276 00113	AIVCHE:					ACTIVE INDUC VAR CHECK
C00278 00114	SLIGEN:					SPROG LINK GEN
C00280 00115	SAEXGE:				SPROG ADDRESS EXPRESSION GEN
C00283 00116	IFNDEF	$NAME,
C00286 00117	EIRGEN:					EXP IN REG GEN
C00289 00118	DRGFIN:					DOUBLE REG GEN FIN
C00291 00119	GR0AGE:					GRNTEE REG 0 AVAIL GEN
C00294 00120	SITGEN:					STORE IN TEMP GEN
C00296 00121	DSITGE:					DOUBLE STORE IN TEMP GEN
C00298 00122	MPOGEN:					MOVEM POSITIVE GEN
C00300 00123	DTEMAK:					DOUBLE TEMP MAKER
C00301 00124	VARSCA:					VAR SCAN
C00302 00125	IDSCAN:					ID SCAN
C00304 00126	STYEVA:					SYMBOL TYPE EVAL
C00305 00127	CONSCA:					CONST SCAN
C00308 00128	RWOCON:					REGISTER WORK CONST
C00310 00129	NOHCSC:					NUM OR HOL CONST SCAN
C00311 00130	RDOLCS:					REAL DBL OR LOG CONST SCAN
C00313 00131	LCOSCA:					LOG CONST SCAN
C00315 00132	CTOFL:					CONVERT TO FL
C00316 00133	EHCSCA:					ENCLOSED HOL CONST SCAN
C00318 00134	SISUSC:					SIGNED SUBSCRIPT SCAN
C00320 00135
C00321 00136	FINUP:					FINISH UP
C00323 00137	OCOPOO:					OUTPUT CONST POOL
C00325 00138	ATCARE:					ADD TO COMMON AREA
C00327 00139	CSACLA:					CALC SIZE AND CLASSIFY
C00329 00140	ALLOEQ:					ALLOC EQUIV
C00331 00141	INISEG:					INITIALIZE SEGS
C00333 00142	LSARNE:					LOAD SEG AND REMOVE NEST
C00335 00143	SEASEG:					SEARCH SEG
C00336 00144	IINCOM:					INTEGRATE INTO COMMON
C00339 00145	IRESOU:					INTEGRATE REM SOURCE
C00341 00146	SAMBOU:					SET AND MOVE BOUNDS
C00342 00147	PGAROL:					PUBLISH GENERAL ALLOC ROLL
C00344 00148	PUBCOM:					PUBLISH COMMON
C00346 00149	OGSROL:					OUTPUT GLOBAL SPROG ROLL
C00348 00150	SOAALL:					SCALAR OR ARRAY ALLOCATION
C00350 00151	OOAREF:					OUTPUT OBJECT ARRAY REF
C00352 00152	PLBERR:					PUBLISH LBL ERRORS
C00354 00153	PDLERR:					PUBLISH DO LOOP ERRORS
C00356 00154	LGAKEE:					LBL GEN AND KEEP
C00357 00155	SUBFAI:					SUBEXP FAIL
C00358 00156	GHEGEN:					GLOBAL HEAD GEN
C00361 00157	PDASTA:					PUNCH DATA STA
C00362 00158	PROCOD:					PROCESS CODE
C00365 00159	CCLAGE:					CONVERT CODE LBL AND GEN
C00366 00160	CABADR:					CODE ABS ADR
C00369 00161	CCOLBL:					CONVERT CODE LBL
C00370 00162	IFNDEF	HALFWD,
C00371 00163	....EOF2
C00372 00164	
C00373 ENDMK
CC"≈!c;
...
DCOXLA:					;DO CONTROL XLATE
	...
	CSF	(COMMA)		;COMMA ;W0√#c ¬INDEX
				;10 LINES REMOVED ;"23S"
				; LINE DELETED ;"23S"
	JSB	(EXPSCA)	;EXP SCAN ;W1C"‚!CFINAL
	SMK	(ITYEM)	;INTEGER TYPE EM
	LCFF	(M12QT)		;NON-INTEGER ERR "20F"
	CSA	(COMMA)	;COMMA
	JSBT	(FESACO)
	FETF	(CONPNT)	;CONST ONE PNTR ;W1C"‚!CINCR
	W1	(SWT)		;W1
	...
	BIK	(.MEM0)		;"23S"
	W1	(STO)		;"23S"
DCOXL2:				;FINAMC¢c!BêSCALAR OR TEMP ;"23S"
	W1	(SWT)		;W1
	...
	BIK	(.MEM0)		;"23S"
	W1	(STO)		;"23S"
DCOXL3:				;INCSC¢c!BêSCALAR OR TEMP ;"23S"
	W1	(SWT)		;W1C"‚!CFINAL;W1C"‚!CINCR;"24-3"
	W2	(SWT)		;W1C#bÄ!CINIT;W1C#c †CINCR;W2√#c ¬FINAL ;"24-3"
	JSB	(GENRUN)	;GEN RUN ;"24-3"
	SMK	(MINEM)		;MINUS EM ;"24-3"
	BAIT	(.MN1)		;MOVN DO REG INST ;"24-3"
	BAIF	(.ME1)		;"24-3"
	W2	(FET)		;W0√#c ¬INDEX ;"23S"
	...
	JSB	(MLGAKE)	;W1C"‚!CMADE LBL ;"23S"
	RSV	(DLOROL)	;DO LOOPS OPEN ROLL ;10TH LINE REPLACED ;"23S"
	W3	(SWT)		;W3C"‚!CMADE LABEL;W1C"‚!CFINAL ;"23S"
	W2	(SWT)		;W3C"‚!CFINAL;W1C"‚!CINCR ;"23S"
...
AGTSXL:					;ASSIGN GO TO STA XLATE
	JSB	(VARSCA)	;W1C¢c!BêVARIABLE POINTER
...
AGTSX2:				;"23FF"
	JSB	(LBLSCA)	;GO TO I,( LABEL ;W1C¢c!BêLABEL ;"23FF"
...
EBSGEN:					;EXPON BY SR GEN
	...
	W1	(SWT)		;W1C¢c!BêEXPONENT,W1C#bÄ!CEOPPNT ;"23-AM"
	SMK	(ITYEM)		;EXPONENT=INTEGER OR DITEM ;"23-AM"
	STKT	(EOPPNT)	;EOPPNUC¢c!BêINTEGER ;"23-AM"
	JSB	(GENRUN)	;"23-AM"
	JSBT	(SAEXGE)	;"23-AM"
	W1	(SWT)		;W1C#bÄ!CEOPPNT,W1C"‚!CEXPONENT ;"23-AM"
	STO	(EOPPNT)	;EOPPNT√#c ¬RESTORED TO DITEM ;"23-AM"
	JSBF	(SAEXGE)	;"23-AM"
	W1	(SWT)		;W1
	SMK	(DITEM)		;"24-7"
...
DRGFIN:					;DOUBLE REG GEN FIN
	...
	SWT	(EOPPNT)	;W0C#c †CEOPPNT,EOPPNTC#c †CTYPE OF ODD REG PNTR ;"23-AK"
	FET	(EOPPNT)	;W0C#c †CODD REG PNTR,W1C"‚!CEOPPNT ;"23-AK"
	JSB	(EIERGE)	;EXPR IN EVEN REG GEN ;"23-AK"
	W1	(SWT)		;W1C#bÄ!CEOPPNT,W1C"‚!CEVEN REG PNTR ;"23-AK"
	STO	(EOPPNT)	;RESTORE EOPPNT,W0C#c †CEVEN REG PNTR ;"23-AK"
